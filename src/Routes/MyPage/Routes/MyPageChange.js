...
const Title = styled.div`
  ...
  font-weight: 500;
  padding: 16px 0px;
  border-bottom: 2px ${props => props.theme.blackColor} solid;
`;
...
export default ({ data: { me } }) => {
  ...
  return (
    <Container>
      <Wrapper>
        <Title>{globalText.text_user_info}</Title>
        <InfoTable>
          <InfoBox>
            <InfoRow>
              ...
              <InfoRow>
                ...
                <InfoRowContent colSpan={2}>
                  <InputContainer>
                    ...
                    <InputWrapper>
                      <InputLabel>{globalText.text_new_pw_confirm}</InputLabel>
                      <InputInner>
                        <Input
                          type="password"
                          ...
                          onBlur={() => {
                            if (newPw.value === newConfirmPw.value) {
                              ...
                              setNewConfirmPwAlert(globalText.text_pwcf_error);
                            }
                          }}
                    ...
                    <InputWrapper style={{ textAlign: "end" }}>
                      ...
                      {pwLoading ? (
                        <InfoRowButton>{globalText.text_confirm}</InfoRowButton>
                      ) : (
